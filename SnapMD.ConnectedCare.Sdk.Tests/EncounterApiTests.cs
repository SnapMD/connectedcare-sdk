...
namespace SnapMD.ConnectedCare.Sdk.Tests
{
    ...
    public class EncounterApiTests : TestBase
    {
        ...
        private readonly UpcomingConsultationResult consultationResult = new UpcomingConsultationResult
        {
            ConsultationId = 1,
        ...
        public void TestGetScheduledConsultations()
        {
            mockWebClient.Setup(client => client.DownloadString(
                ...
                .Returns(JsonConvert.SerializeObject(new ApiResponseV2<UpcomingConsultationResult>(consultationResult)));
